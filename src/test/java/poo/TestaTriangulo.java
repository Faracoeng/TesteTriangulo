...
public class TestaTriangulo {
    ...
    public void testarTriangulo(){
        ...
        Assert.assertEquals("3x4x8 não é um triângulo","Não é um triângulo", tri.tipo(3,4,8));
        ...
        Assert.assertEquals("2x10x1 não é um triângulo","Não é um triângulo", tri.tipo(2,10,1));
        Assert.assertEquals("-1x5x5 não é um triângulo","Não é um triângulo", tri.tipo(-1,5,5));
        Assert.assertEquals("4x7x6 não é um triângulo","É um triângulo Escaleno", tri.tipo(4,7,6));
